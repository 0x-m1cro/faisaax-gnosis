...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[exports.ChainId.TESTNET] = '0x91B13eA3def246E1a376A773e3623571A939736D', _FACTORY_ADDRESS);
var INIT_CODE_HASH = '0xe56458e8ba827eec636d836a35494461ddcbdd957119f1fc80f510684cbe2cdd';
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0xf6077b8dacec85be11d8d2da04e1705668985bcf', 18, 'WCORE', 'Wrapped CORE'), _WETH[exports.ChainId.TESTNET] = /*#__PURE__*/new Token(exports.ChainId.TESTNET, '0xDb4C908A02733E249FD57DDd46661c274A808b96', 18, 'WCORE', 'Wrapped CORE'), _WETH);
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'FAISAA-LP', 'FAISAA');
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) == null ? void 0 : (_PAIR_ADDRESS_CACHE$t = _PAIR_ADDRESS_CACHE[tokens[0].address]) == null ? void 0 : _PAIR_ADDRESS_CACHE$t[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE2 = PAIR_ADDRESS_CACHE) == null ? void 0 : _PAIR_ADDRESS_CACHE2[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = address.getCreate2Address(FACTORY_ADDRESS[tokens[0].chainId], solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), INIT_CODE_HASH), _extends2)), _extends3));
    }
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var devIn = trade.inputAmount.currency === ETHER;
    var devOut = trade.outputAmount.currency === ETHER;
    // the router does not support both ether in and out
    !!(devIn && devOut) ?  invariant(false, 'FAISAA_IN_OUT')  : void 0;
...
//# sourceMappingURL=faisaa-sdk.cjs.development.js.map
